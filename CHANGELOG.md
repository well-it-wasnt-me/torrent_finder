...
- Telegram `status` command now shows only active downloads by default; `status all` lists every torrent with human-friendly explanations of Transmission’s states.
